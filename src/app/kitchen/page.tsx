...
export default function KitchenPage() {
  ...
  const kitchenImages = [
    ...
    },
    {
      ...
      alt: 'Kitchen View 2',
      description: 'Spacious countertops with elegant finishes'
    }
  ];
  ...
  const navigateLightbox = (direction: 'prev' | 'next') => {
    ...
    if (direction === 'prev') {
      ...
      if (newIndex < kitchenImages.length - 1) {
        newIndex = newIndex + 1;
      } else {
    ...
    setLightbox({
      ...lightbox,
      src: kitchenImages[newIndex].src,
      index: newIndex
    });
  };
    ...
    <div className="category-page">
      ...
      <div className="category-header">
        <div className="container">
          <h1>Kitchen</h1>
          <p>Explore our modern kitchen designs with premium finishes</p>
        </div>
      </div>
      ...
      <section className="category-gallery">
        <div className="container">
          <div className="category-intro" data-aos="fade-up">
            <h2>Gourmet Kitchens</h2>
            <p>
              Our kitchens are designed with both functionality and aesthetics in mind. 
              Featuring premium appliances, sleek countertops, and elegant cabinetry, 
              these kitchens are perfect for cooking enthusiasts and family gatherings.
            </p>
          </div>
      ...
      {lightbox.show && (
        <div className="lightbox" onClick={closeLightbox}>
          ...
          <button 
            className={`nav-button next-button ${lightbox.index === kitchenImages.length - 1 ? 'disabled' : ''}`} 
            onClick={(e) => { e.stopPropagation(); navigateLightbox('next'); }}
            disabled={lightbox.index === kitchenImages.length - 1}
          >
            &rsaquo;
          </button>
        </div>
